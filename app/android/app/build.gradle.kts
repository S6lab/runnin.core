...
android {
    ...
    defaultConfig {
        ...
        // health plugin requires API 26+ (Android 8.0). Cobre 95%+ dos devices ativos.
        minSdk = 26
...
dependencies {
    ...
    // API estável desde 1.0. Runtime guard pra API >= 30 (Android 11) no
