...
class CoachChatCubit extends Cubit<CoachChatState> {
  ...
  CoachChatCubit()
      : _ds = CoachRemoteDatasource(),
        super(CoachChatState(messages: [
          ChatMessage(
            content: 'Oi! Sou seu coach de corrida IA. Como posso te ajudar hoje?',
  ...
  Future<void> sendMessage(String text) async {
    ...
    final userMsg = ChatMessage(content: text.trim(), sender: MessageSender.user);
    emit(state.copyWith(
