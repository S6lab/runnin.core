...
class WeekPlanRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final accent = switch (state) {
      WeekPlanRowState.ok => palette.primary,
      WeekPlanRowState.today => palette.secondary,
      WeekPlanRowState.future => palette.textSecondary,
      WeekPlanRowState.rest => palette.muted,
    };
